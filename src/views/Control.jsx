...
function Control({ programs, setPrograms, onUpload, canWrite, notify, spjList, setSpjList, lkaData, setLkaData, kartuList, setKartuList, dpaList, setDpaList, usulanRka, isSuperAdmin }) {
