...
function App() {
  ...
  useEffect(() => {
    ...
    Promise.all([api('/programs'), api('/docs'), api('/events'), api('/log'), api('/users')]).then(([p,d,e,l,u]) => { setPrograms(p); setDocs(d); setEvents(e); setAuthLog(l); setUsers(u) }).catch(() => notify('Gagal memuat data server'))
  }, [currentUser])
  ...
  return <div className="app-shell">
    ...
    <main className="main">
      ...
      <div className="content">
        ...
        {active === 'pengaturan' && <Settings role={role} setRole={setRole} notify={notify} currentUser={currentUser} users={users} authLog={authLog} />}
      </div>
    </main>
